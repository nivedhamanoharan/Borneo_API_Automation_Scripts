...
public class Utils {
    ...
    public static String getResourcesPath() {
        ...
        // workingDir = workingDir.replaceAll(pathArray[pathArray.length - 1], "MPokket_API_Automation_Scripts");
    ...
    public static String getWorkingDirectory() {
        ...
        if (!("JENKINS".equalsIgnoreCase("LOCAL"))) {
            workingDir = System.getProperty("user.dir");
            String[] pathArray = splitPath(workingDir);
            workingDir = workingDir.replaceAll(pathArray[pathArray.length - 1], "Borneo_API_Automation_Scripts");
        }
        if (!workingDir.contains("target"))
    ...
    public static String getWorkingDirectory_withoutTarget() {
        String workingDir = System.getProperty("user.dir");
        if ("LOCAL".equalsIgnoreCase("JENKINS")) {
            return workingDir;
        } else {
            String[] pathArray = splitPath(workingDir);
            workingDir = workingDir.replaceAll(pathArray[pathArray.length - 1], "MPokket_API_Automation_Scripts");
